...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def open_Image(self):
        ...
        if self.ImagButton1==1:
            ...
            if self.sizeFlag2==1:
                if self.sizeImg1!=self.sizeImg2:
            ...
            if self.sizeFlag1==1:
                self.sizeImg2=self.img2.imgByte.shape
                if self.sizeImg1 !=self.sizeImg2:
                    logger.debug('Two Images have not the same size')
                    self.showMessageBox('Warning','Two Images have not the same size')
    ...
    def display_DFT(self,ComboBox,Imge,QLable):
        ...
        if self.comImg ==Modes.magnitudeFFT.value:
            ...
            self.spectrum=Imge.invmagnitude
            ...
            self.spectrum=Imge.unimagnitude
            ...
            self.spectrum=Imge.uniphase
            logger.debug('returned uni_Phase_Component_Imag1')

        self.image=QImage(self.spectrum, self.spectrum.shape[0],self.spectrum.shape[1],QImage.Format_Grayscale8)
        self.image=QPixmap.fromImage(self.image)
        QLable.setScaledContents(True)
        QLable.setPixmap(self.image)
    ...
    def option(self):
        ...
        if self.ui.radioButton.isChecked():
           self.Mode(self.img1,self.img2,self.comImg)
            ...
            self.Mode(self.img2,self.img1,self.comImg) 
